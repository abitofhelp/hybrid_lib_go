...
#### Cross-Cutting
- **Version Package**: Exported `version/` package for library consumers
...
#### Release Scripts
- **Library Detection**: go.py auto-detects library vs app for version path
  - Libraries use exported `version/` package
  - Applications use `internal/version/` package
- **Embedded Version Generation**: ada.py embeds version generation logic
